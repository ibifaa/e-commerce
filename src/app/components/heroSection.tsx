...
function HeroSection() {
  return (
    <section className="hero-section text-black min-h-full  body-font bg-[url('/images/png/hero-img.png')]  sm:bg-cover sm:bg-center bg-no-repeat px-[20px] mb-[50px]">
      ...
      <div className="container mx-auto flex px-5  flex-col w-full h-full">
        <div className="my-[25%] w-full sm:pr-24  flex flex-col sm:items-start sm:text-left mb-16 sm:mb-0 place-item-end ">
          <div className="sm:mx-[40px] mx-[20px]">
            ...
            <p className="mb-8 leading-relaxed text-center sm:text-left sm:w-[60%]">
      ...
      <hr className="border-[black] sm:m-[40px] py-[20px]" />
    </section>
  );
}
