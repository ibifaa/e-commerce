...
function Card({src, price, name}) {
  ...
  return (
    <div className='card'>
    <div className="h-[400px]  bg-center bg-cover bg-no-repeat border border-black"  style={{ backgroundImage: backgroundImageStyle }}>
      
      <div className="mt-4 flex justify-between">
        <button className=' mx-[20px] py-[2px] m-auto px-[10px] border border-black bg-[white] text-[1rem]'>NEW</button>
        <div className='mx-[20px]'>
          <img src="/images/svg/pseudo.svg" className='my-[10px]' alt="icon" />
